...
public class BaseConstant {
    public static final String REDIS_TOKEN_KEY = "backend:user:token:";//redis 存储token的key值，用于获取用户信息
    public static final int REDIS_TOKEN_KEY_EXPIRE = 30;//超时时间，单位：分钟
    ...
    public static final String USER_LOCALE_DEFAULT = USER_LOCALE_ZH_HK;//默认国际化标识为繁体中文
