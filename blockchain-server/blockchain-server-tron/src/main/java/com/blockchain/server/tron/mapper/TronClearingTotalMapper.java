...
/**
 * TronClearingTotalMapper 数据访问类
 *
 * @version 1.0
 * @date 2019-02-16 15:44:06
 */
@Repository
public interface TronClearingTotalMapper extends Mapper<TronClearingTotal> {
     ...
     * @return
     */
    TronClearingTotal selectNewestOne(@Param("addr") String addr,
