 ...
 **/
public class TronWalletCreateApi {

    public static final String CONTROLLER_API = "创建账户管理控制器";
    ...
    public static class Update {
        public static final String METHOD_TITLE_NAME = "修改用户接口";
        public static final String METHOD_TITLE_NOTE = "修改用户";
        public static final String METHOD_API_ADDR = "账户地址";
        public static final String METHOD_API_REMAKR = "描述";
