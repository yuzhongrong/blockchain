 ...
 */
public interface ITronClearingDetailService {
     ...
     * @return
     */
    List<TronClearingDetail> selectByTotalId(String totalId);
     ...
     * @param toMap
     */
    void insert(TronClearingTotal total,
     ...
     * @param type  类型
     */
    void insert(TronClearingTotal total, Map<String, Map<String, BigDecimal>> map, String type);
