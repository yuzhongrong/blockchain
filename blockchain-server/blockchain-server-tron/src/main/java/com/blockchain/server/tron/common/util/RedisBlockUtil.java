...
public class RedisBlockUtil {
    //  储存区块的初始化高度
    static final String TRON_BLOCKCHAIN_BEGIN = "tron:blockchain:begin";
    //  储存区块的当前最新高度
    static final String TRON_BLOCKCHAIN_CURRENT = "tron:blockchain:current";
    //  储存区块的链上最新高度
    static final String TRON_BLOCKCHAIN_NEWEST = "tron:blockchain:newest";
    //  储存所有遗漏区块的爬取状态
    static final String TRON_BLOCKCHAIN_OPT_HASH = "tron:blockchain:opt:hash";
    ...
    public static void setBlockBegin(BigInteger blockNumber, RedisTemplate redisTemplate) {
        redisTemplate.opsForValue().set(TRON_BLOCKCHAIN_BEGIN, blockNumber);
    }
    ...
    public static BigInteger getBlockBegin(RedisTemplate redisTemplate) {
        Object blockBegin = redisTemplate.opsForValue().get(TRON_BLOCKCHAIN_BEGIN);
    ...
    public static void setBlockNewest(BigInteger blockNumber, RedisTemplate redisTemplate) {
        redisTemplate.opsForValue().set(TRON_BLOCKCHAIN_NEWEST, blockNumber);
    }
    ...
    public static BigInteger getBlockNewest(RedisTemplate redisTemplate) {
        Object blockBegin = redisTemplate.opsForValue().get(TRON_BLOCKCHAIN_NEWEST);
        return DataCheckUtil.objToBigInteger(blockBegin);
    }
    ...
    public static void setBlockCurrent(BigInteger blockNumber, RedisTemplate redisTemplate) {
        redisTemplate.opsForValue().set(TRON_BLOCKCHAIN_CURRENT, blockNumber);
    }
    ...
    public static BigInteger getBlockCurrent(RedisTemplate redisTemplate) {
        Object blockBegin = redisTemplate.opsForValue().get(TRON_BLOCKCHAIN_CURRENT);
        return DataCheckUtil.objToBigInteger(blockBegin);
    }
    ...
    public static Integer getBlockOptMapCount(BigInteger hashKey, RedisTemplate redisTemplate) {
        Object val = redisTemplate.opsForHash().get(TRON_BLOCKCHAIN_OPT_HASH, hashKey);
    ...
    public static void setBlockOptMapCount(BigInteger hashKey, RedisTemplate redisTemplate) {
        redisTemplate.opsForHash().put(TRON_BLOCKCHAIN_OPT_HASH, hashKey, 1);
    }
    ...
    public static void incrementBlockOptMapCount(BigInteger hashKey, RedisTemplate redisTemplate) {
        redisTemplate.opsForHash().increment(TRON_BLOCKCHAIN_OPT_HASH, hashKey, 1);
    }
    ...
    public static void delBlockOptMapCount(BigInteger hashKey, RedisTemplate redisTemplate) {
        redisTemplate.opsForHash().delete(TRON_BLOCKCHAIN_OPT_HASH, hashKey);
    }
