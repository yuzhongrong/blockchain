...
public enum BtcWalletEnums {
    ...
    OUT_WALLET_BALENCE_INSUFFICIENT(12703, "操作失败，发币账户余额不足", "Operation failed, insufficient balance in issuing account", "操作失敗，發幣賬戶余額不足"),
    ...
    BtcWalletEnums(int code, String cnmsg, String enMsg, String hkmsg) {
        this.code = code;
        this.cnmsg = cnmsg;
        this.enMsg = enMsg;
        this.hkmsg = hkmsg;
