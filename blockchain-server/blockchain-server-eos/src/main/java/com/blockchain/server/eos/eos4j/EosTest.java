...
//
//    private static Rpc rpc = new Rpc("https://api-kylin.eosasia.one");
//    private static final RestTemplate restTemplate = new RestTemplate(getClientHttpRequestFactory());
//
//    private static final String EOS_RPC_URI = "http://api-kylin.eosasia.one/";
...
//
//         String amount = new BigDecimal("1.000000000000000000").subtract(new BigDecimal("0.100000000000000000")).setScale(4, BigDecimal.ROUND_HALF_UP).toString() + " " + "EOS";
//         try {
//             Transaction transfer = rpc.transfer(privateKeys, "eosio.token", creator, newAccount, amount, "123123");
