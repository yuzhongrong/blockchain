...
public enum EosWalletEnums {
    ...
    WITHDRAW_DEPOSIT_ACCOUNT_ERROR(12500,"提现账户不能为提币地址","The withdrawal account cannot be the withdrawal address","提現賬戶不能為提幣地址"),
    ...
    EOS_RPC_GET_BLOCK_ERROR(15000, "获取区块异常！", "Get block exceptions!", "獲取區塊異常！")
