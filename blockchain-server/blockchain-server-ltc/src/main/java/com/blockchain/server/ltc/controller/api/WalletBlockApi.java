 ...
 **/
public class WalletBlockApi {

    public static final String API_NAME = "LTC钱包控制器";
    ...
    public static class TotalBalance {
        public static final String METHOD_TITLE_NAME = "查询节点钱包的所有余额";
        public static final String METHOD_TITLE_NOTE = "查询节点钱包的所有余额";
    }
