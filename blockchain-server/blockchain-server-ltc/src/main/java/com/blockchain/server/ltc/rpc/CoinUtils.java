...
public class CoinUtils {
    ...
    public String getNewAddress() throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getNewAddress(String):{} ===", e.getMessage(), e);
            throw new WalletException(WalletEnums.GET_NEW_ADDRESS_ERROR);
        }
    }
    ...
    public JSONArray listUnspent(String address) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.listUnspent(String):{} ===", e.getMessage(), e);
            throw new WalletException(WalletEnums.LIST_UNSPENT_ERROR);
        }
    }
    ...
    public JSONObject validateAddress(String address) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.validateAddress(String):{} ===", e.getMessage(), e);
            throw new WalletException(WalletEnums.ADDRESS_ERROR);
        }
    }
    ...
    public double getBalance(String account) throws Exception {
        ...
        try {
            ...
            LOG.info("=== CoinUtils.getBalance(String...):{} ===", e.getMessage(), e);
    ...
    /**
     * 从钱包内向指定的地址发送指定数量的莱特币，简单交易，钱包内随机指定或创建地址作为发送地址、找零地址
     *
     * @param toAddress 地址
     * @param amount    数量
     * @return 交易ID
...
//        //验证数量
//        ExceptionPreconditionUtils.checkNotNull(amount, new WalletException(WalletEnums.AMOUNT_NULL));

        try {
            return client.getClient().invoke("sendtoaddress", new Object[]{toAddress, amount}, String.class);
        } catch (Throwable e) {
            LOG.info("=== CoinUtils.sendToAddress(String, double):{} ===", e.getMessage(), e);
            throw new WalletException(WalletEnums.SENDTOADDRESS_ERROR);
        }
    }
    ...
    public Object sendMany(String fromaccount, Object target) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.signSendToAddress(String, double):{} ===", e.getMessage(), e);
    ...
    public Object getRawTransaction(String txId, int verbose) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getRawTransaction(String):{} ===", e.getMessage(), e);
    ...
    public JSONObject getTransaction(String txId) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getTransaction(String):{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage() + String.format("[params]: txId=%s", txId));
        }
    }
    ...
    public Object setAccount(String address, String account) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.setAccount(String, String):{} ===", e.getMessage(), e);
    ...
    public Object listReceivedByAddress(int minconf) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.listReceivedByAddress(int minconf):{} ===", e.getMessage(), e);
    ...
    public Object settxfee(double account) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.settxfee(double):{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage() + String.format("[params]: account=%s", account));
        }
    }
    ...
    public Object encryptwallet(String passphrase) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.encryptwallet(String) ===", e.getMessage(), e);
    ...
    public Object walletpassphrase(String passphrase, int timeout) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.walletpassphrase(String, int):{} ===", e.getMessage(), e);
    ...
    public String createRawTransaction(Object utxo, String toAddress, double amonut) throws Exception {
        ...
        try {
            ...
            LOG.info("=== CoinUtils.createRawTransaction(Object):{} ===", e.getMessage(), e);
    ...
    public String fundRawTransaction(String hexString, String address) throws Exception {
        ...
        try {
            ...
            LOG.info("=== CoinUtils.fundRawTransaction(Object):{} ===", e.getMessage(), e);
    ...
    public String signRawTransaction(String hexString) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.signrawTransaction(String):{} ===", e.getMessage(), e);
    ...
    public String sendRawTransaction(String hexHash) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.sendRawTransaction(String):{} ===", e.getMessage(), e);
    ...
    public Object decoderawtransaction(String hex) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.decoderawtransaction(String):{} ===", e.getMessage(), e);
    ...
    public String getBlockHash(int index) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getBlockHash(int):{} ===", e.getMessage(), e);
    ...
    public Integer getBlockCount() throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getBlockHeader():{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage());
        }
    }
    ...
    public ArrayList<String> getblock(String blockHash) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getblock(String):{} ===", e.getMessage(), e);
    ...
    public String getPrivateKeyByAddress(String address) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getPrivateKeyByAddress(String):{} ===", e.getMessage(), e);
    ...
    public int getBlockHeader(String headerHash) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getBlockHeader(String):{} ===", e.getMessage(), e);
    ...
    public JSONArray listSinceBlock(String headerHash) throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.listSinceBlock(String):{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage() + String.format("[params]: headerHash=%s", headerHash));
        }
    }
    ...
    public String sendWithRaw(String fromAddress, String toAddress, double amonut, String changeAddress) throws Exception {
        ...
        try {
            ...
            LOG.info("=== CoinUtils.sendWithRaw(String):{} ===", e.getMessage(), e);
    ...
    public double getUnconfirmedBalance() throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.getUnconfirmedBalance():{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage());
        }
    }
    ...
    public JSONArray listAddressGroupings() throws Exception {
        try {
            ...
            LOG.info("=== CoinUtils.listaddressgroupings():{} ===", e.getMessage(), e);
            throw new Exception(e.getMessage());
        }
    }
...
//            return balance;
            ...
            LOG.info("=== CoinUtils.getBalanceByAddr(String):{} ===", e.getMessage(), e);
