...
public interface WalletMapper extends Mapper<Wallet> {
     ...
     * @return
     */
    WalletDTO selectByAddrAndTokenAddr(@Param("addr") String addr,
     ...
     * @return
     */
    WalletDTO selectByAddrAndTokenAddrAndWalletType(@Param("addr") String addr,
                                                    @Param("tokenId") String tokenId,
     ...
     * @return
     */
    WalletDTO selectByUserOpenIdAndTokenAddrAndWalletType(@Param("userOpenId") String userOpenId,
                                                          @Param("tokenId") String tokenId,
                                                          @Param("walletType") String walletType);
     ...
     * @return
     */
    List<WalletDTO> selectByAddrAndWalletType(@Param("addr") String addr,
                                              @Param("walletType") String walletType);
