...
public class RedisBlockUtil {
    //  储存区块的初始化高度
    static final String ETH_BLOCKCHAIN_BEGIN = "eth:blockchain:begin";
    //  储存区块的当前最新高度
    static final String ETH_BLOCKCHAIN_CURRENT = "eth:blockchain:current";
    //  储存区块的链上最新高度
    static final String ETH_BLOCKCHAIN_NEWEST = "eth:blockchain:newest";
    //  储存所有遗漏区块的爬取状态
    static final String ETH_BLOCKCHAIN_OPT_HASH = "eth:blockchain:opt:hash";
