...
import com.blockchain.server.eth.service.impl.EthWalletServiceImpl;
    ...
    public String ethWalletTransfer(String fromAddr, String fromPrivateKey, String toAddr, BigInteger tBalance, BigInteger gasPrice) {
        try {
            ...
            EthGetTransactionCount ethGetTransactionCount =
                    web3j.ethGetTransactionCount(fromAddr, DefaultBlockParameterName.PENDING).send();
    ...
    public String ethWalletTransfer(String fromAddr, String fromPrivateKey, String toAddr, BigInteger tBalance) {
        try {
            ...
            EthGetTransactionCount ethGetTransactionCount =
                    web3j.ethGetTransactionCount(fromAddr, DefaultBlockParameterName.PENDING).send();
            BigInteger nonce = ethGetTransactionCount.getTransactionCount();
            logger.info("ETH_GAS_PRICE"+ETH_GAS_PRICE+"ETH_GAS_LIMIT"+ETH_GAS_LIMIT);
            ...
            logger.error("eth transfer fail mess:"+e.getMessage());
            e.printStackTrace();
            throw new EthWalletException(EthWalletEnums.SERVER_IS_TOO_BUSY);
        }
    }
...
//        throw new EthWalletException(EthWalletEnums.SERVER_IS_TOO_BUSY);
    ...
    private BigInteger getGas() {
        BigInteger ethGas=ETH_GAS_PRICE.multiply(ETH_GAS_LIMIT);
        return ethGas;
    }
