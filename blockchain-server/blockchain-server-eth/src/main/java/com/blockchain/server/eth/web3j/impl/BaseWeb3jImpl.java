...
import com.blockchain.server.eth.service.impl.WalletOutServiceImpl;
...
public class BaseWeb3jImpl implements IBaseWeb3j {
    ...
    private Logger logger = LoggerFactory.getLogger(BaseWeb3jImpl.class);
    ...
    public String transact(String fromAddr, String fromPrivateKey, String hashVal, String month, BigInteger gasPrice,
        ...
        logger.info("to addr is:"+ JSON.toJSONString(inputParameters));
        try {
    ...
    @Override
    public TransactionReceipt getTransactionStatusByHash(String hash) {
        try {
