 ...
 **/
public class SysconfVersionApi {

    public static final String CONTROLLER_API = "版本管理控制器";
    ...
    public static class Add {
        ...
        public static final String METHOD_API_VERSION="版本数据";
    }
    ...
    public static class Remove {
        ...
        public static final String METHOD_API_IDS="版本id";
    }
