 ...
 **/
public class SysconfWgtVersionApi {

    public static final String CONTROLLER_API = "补丁管理控制器";
    ...
    public static class Add {
        ...
        public static final String METHOD_API_WGTVERSION="补丁数据";
    }
    ...
    public static class Remove {
        ...
        public static final String METHOD_API_IDS="补丁id";
    }
}
